...
class DaThuc:
    ...
    def Tich(self, dathuc2):
        ...
        # Duyệt từng số hạng của dathuc1
        current1 = self.Head
        while current1 is not None:
            # Duyệt từng số hạng của dathuc2
            current2 = dathuc2.Head
            while current2 is not None:
                # Nhân hai số hạng lại với nhau và thêm vào kết quả
...
ketqua = dathuc1.Tich(dathuc2)
ketqua.Xuat()  # Output: 3x^4 + 8x^3 - 7x^2 - 13x^1 - 15
